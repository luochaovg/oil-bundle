...
trait Preview
{
    ...
    {
        return [
            new Button('New record', 'app_bsw_admin_role_access_control_persistence', 'a:plus'),
        ];
    }
    ...
    {
        return [
            (new Button('Edit record', 'app_bsw_admin_role_access_control_persistence'))->setArgs(['id' => $current['id']]),
        ];
    }
