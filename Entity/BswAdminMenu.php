...
class BswAdminMenu extends FoundationEntity
{
     ...
     * @BswAnnotation\Filter(sort=8, type=BswForm\Select::class, placeholder="Mode", group="sort", style={"width": "45%"}, enum=BswFilter\Senior::MODE, column=3)
     * @BswAnnotation\Filter(sort=8, type=BswForm\Input::class, placeholder="Value", group="sort", style={"width": "55%"}, title="Split by ~")
