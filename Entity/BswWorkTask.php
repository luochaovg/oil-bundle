...
class BswWorkTask extends FoundationEntity
{
     ...
     * @Assert\NotNull(groups={"modify"})
     * @BswAnnotation\Preview(sort=3.1, width=130, align="center", render=BswAbs::RENDER_ROUND_PERCENT)
     ...
     * @Assert\Type(type="integer", groups={"modify"})
     * @Assert\NotNull(groups={"modify"})
     * @BswAnnotation\Preview(sort=3.4, width=130, align="center")
     ...
     * @Assert\Type(type="integer", groups={"modify"})
     * @Assert\NotNull(groups={"modify"})
     * @BswAnnotation\Preview(sort=3.2, width=130, align="center", enum=true, dress={1:"blue",2:"orange",3:"green",4:"cyan"})
