...
class BswAdminRole extends FoundationEntity
{
     ...
     * @Assert\NotNull(groups={"modify"})
     * @BswAnnotation\Preview(sort=3, align="center", render=BswAbs::RENDER_CODE, width=190)
     * @BswAnnotation\Persistence(sort=3, show=false, type=BswForm\Datetime::class)
     * @BswAnnotation\Filter(sort=3, type=BswForm\DatetimeRange::class, column=4, filter=BswFilter\Between::class)
     */
    protected $addTime;
     ...
     * @Assert\Type(type="integer", groups={"modify"})
     * @Assert\NotNull(groups={"modify"})
     * @BswAnnotation\Preview(sort=5, align="center", enum=true, dress={0:"default", 1:"processing"}, status=true)
